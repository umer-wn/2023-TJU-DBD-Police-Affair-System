<template>
  <main class="main">
    <div class="headpic">
      ...
      <div class="content1">
        <div class="headbar" @mousemove="handleMouseMove">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;工资补贴管理</div>
      </div>
    ...
    <section>
      <div style="width:100%">
        <button class="ssqbutton1-1" @mousemove="handleMouseMove" style="width:49%;display:inline-block"><span>记录搜索</span></button>
        <button class="ssqbutton1-2" @mousemove="handleMouseMove" style="width:49%;display:inline-block" @click="goToDataStatistics"><span>数据统计</span></button>
      </div>
      ...
      <div>&nbsp;</div>
      <lable style="position: relative;display: block;"><div class="ssqinputtext">输入姓名</div><input class="ssqinputinfobox" type="text" v-model="inputName" placeholder="输入姓名"></lable>
      <div>&nbsp;</div>
      <lable style="position: relative;display: block;"><div class="ssqinputtext">选择时间</div><input class="ssqinputinfobox" type="text" v-model="inputTime" placeholder="选择时间"></lable> 
      <div>&nbsp;</div>
      <lable style="position: relative;display: block;"><div class="ssqinputtext">选择警局</div><input class="ssqinputinfobox" type="text" v-model="inputPoliceStation" placeholder="选择警局"></lable> 
      ...
      <div><button class="ssqbutton1" @click="submitSearch" @mousemove="handleMouseMove"><span>筛选</span></button></div>
      <div><button class="ssqbutton1" @click="goToNewRecord" @mousemove="handleMouseMove"><span>新建记录</span></button></div>
      <div class="g-table">
        <table>
          <thead>
            <tr>
        ...
        <div class="g-scroll">
          <table>
            <tbody>
              <tr v-for="rrr in 10" :key="rrr">
                <td>123456</td>
                <td>kusoyaro</td>
                <td>aaaaaa</td>
                <td><button @click="goToDetailPage(rrr)">查看</button></td>
              </tr>
            </tbody>
          </table>
        </div>
