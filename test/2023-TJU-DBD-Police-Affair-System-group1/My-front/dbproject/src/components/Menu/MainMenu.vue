<template>
  <el-container class="home-container" :style="{
    height: containerHeight + 'px',
    backgroundSize: '100% ' + containerHeight + 'px',
  }" @wheel="handleScroll">
    <!-- 头部 -->
    <el-header style="height: 70px; padding: 0; text-align: justify; hyphens: auto">
      <div class="headpic">
        <div class="header1">
    ...
    <el-container>
      ...
      <el-aside width="200px">
        <el-menu router class="el-menu-vertical-demo" default-active="/mainMenu/MainPage" background-color="transparent"
          text-color="#ffffff" active-text-color="#ffd04b">
          <el-menu-item v-if="myAuthority >= 0" index="/mainMenu/MainPage" @click="scrollToTop">
            <img class="nav-icon-for-menu-item" src="../../assets/logos/MainPage.png" alt="Icon" />
            &nbsp;主&nbsp;页
          </el-menu-item>
          ...
          <el-sub-menu index="1-1">
            ...
            <template #title>
              <span>
                <img class="nav-icon-for-sub-menu" src="../../assets/logos/PoliceManagement.png" alt="Icon" />
                警员管理</span>
            </template>
            <el-menu-item v-if="myAuthority >= 1" index="/mainMenu/Register" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/Register.png" alt="Icon" />
              注&nbsp;册
            </el-menu-item>
            <el-menu-item v-if="myAuthority >= 2" index="/mainMenu/ChangePermission" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/ChangePermission.png" alt="Icon" />
              警员权限修改
            </el-menu-item>
            <el-menu-item v-if="myAuthority >= 2" index="/mainMenu/PermissionManage" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/PermissionManage.png" alt="Icon" />
              修改申请管理
            </el-menu-item>
            <el-menu-item v-if="myAuthority >= 1" index="/mainMenu/PoliceAssessment" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/PoliceAssessment.png" alt="Icon" />
              警员考核管理
            </el-menu-item>
            <el-menu-item v-if="myAuthority >= 4" index="/mainMenu/PoliceStationInfoManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/PoliceStationInfoManagement.png" alt="Icon" />
              警局信息管理
            </el-menu-item>
            <el-menu-item v-if="myAuthority >= 0" index="/mainMenu/PoliceOfficerInfoManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/PoliceOfficerInfoManagement.png" alt="Icon" />
              警员信息管理
            </el-menu-item>
            <el-menu-item v-if="myAuthority >= 1" index="/mainMenu/AttendanceManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/AttendanceManagement.png" alt="Icon" />
              警员出勤管理
            </el-menu-item>
            <el-menu-item v-if="myAuthority >= 1" index="/mainMenu/VideoManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/VideoManagement.png" alt="Icon" />
              执法录像管理
            </el-menu-item>
            <el-menu-item v-if="myAuthority >= 1" index="/mainMenu/AlarmResponseRecordManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/AlarmResponseRecordManagement.png" alt="Icon" />
              接警记录管理
            </el-menu-item>

            <el-menu-item index="/mainMenu/PayrollManagement" v-if="myAuthority >= 4" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/PayrollManagement.png" alt="Icon" />
              薪水管理
            </el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu v-if="myAuthority >= 1" index="1-2">
            <template #title>
              <span>
                <img class="nav-icon-for-sub-menu" src="../../assets/logos/CaseManagement.png" alt="Icon" />
                案件管理</span>
            </template>

            <el-menu-item index="/mainMenu/SuspectInfoManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/SuspectInfoManagement.png" alt="Icon" />
              嫌疑人信息管理
            </el-menu-item>
            <el-menu-item index="/mainMenu/CriminalRecordManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/CriminalRecordManagement.png" alt="Icon" />
              犯罪记录管理
            </el-menu-item>
            <el-menu-item index="/mainMenu/VictimInfoManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/VictimInfoManagement.png" alt="Icon" />
              受害人信息管理
            </el-menu-item>
            <el-menu-item index="/mainMenu/CaseClassificationManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/CaseClassificationManagement.png" alt="Icon" />
              案件分类与管理
            </el-menu-item>
            <el-menu-item index="/mainMenu/CrimeDataStatistics" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/CrimeDataStatistics.png" alt="Icon" />
              犯罪数据统计
            </el-menu-item>
            <el-menu-item index="/mainMenu/KeyIndividualsManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/KeyIndividualsManagement.png" alt="Icon" />
              重点人员统计
            </el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu v-if="myAuthority >= 1" index="1-3">
            <template #title>
              <img class="nav-icon-for-menu-item" src="../../assets/logos/EquipmentManagement.png" alt="Icon" />
              <span>装备管理</span>
            </template>
            <el-menu-item index="/mainMenu/PoliceVehicleManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/PoliceVehicleManagement.png" alt="Icon" />
              警车管理
            </el-menu-item>
            <el-menu-item index="/mainMenu/PoliceEquipmentManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/PoliceEquipmentManagement.png" alt="Icon" />
              警械管理
            </el-menu-item>
          </el-sub-menu>
          ...
          <el-sub-menu v-if="myAuthority >= 1" index="1-4">
            <template #title>
              <img class="nav-icon-for-menu-item" src="../../assets/logos/UrbanResidentmanagement.png" alt="Icon" />
              <span>城区和居民管理</span>
            </template>

            <el-menu-item index="/mainMenu/CitizenInfoManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/CitizenInfoManagement.png" alt="Icon" />
              公民户籍管理
            </el-menu-item>
            <el-menu-item index="/mainMenu/UrbanZoningManagement" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/UrbanZoningManagement.png" alt="Icon" />
              城市地区管理
            </el-menu-item>
            <el-menu-item index="/mainMenu/RegionalDispatch" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/RegionalDispatch.png" alt="Icon" />
              城市调度管理
            </el-menu-item>
            <el-menu-item index="/mainMenu/FamilybgCheck" @click="scrollToTop">
              <img class="nav-icon-for-menu-item" src="../../assets/logos/FamilybgCheck.png" alt="Icon" />
              家族背景调查
            </el-menu-item>
          </el-sub-menu>

          <el-menu-item v-if="myAuthority >= 1" index="/mainMenu/CaseInvestigation" @click="scrollToTop">
            <img class="nav-icon-for-menu-item" src="../../assets/logos/CaseInvestigation.png" alt="Icon" />
            案件办理
          </el-menu-item>
        </el-menu>
      </el-aside>
...
.el-aside {
  ...
  background-image: url("../../assets/sdtest.jpg");
  /* 替换为你的背景图路径 */
...
.header1 {
  background: #1f2cdf;
  background-image: url("../../assets/hdtest.jpg");
  /* 替换为你的背景图路径 */
